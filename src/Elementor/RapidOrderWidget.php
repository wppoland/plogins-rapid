<?php
/**
 * Elementor widget: Tujo quick order form.
 *
...
final class RapidOrderWidget extends Widget_Base
{
    ...
    {
        return esc_html__('Quick Order Form', 'tujo');
    }
    ...
    protected function register_controls(): void
    {
        $this->start_controls_section(
            'content',
            ['label' => esc_html__('Quick order form', 'tujo')]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => esc_html__('This block renders the Tujo quick order form. It has no options here, configure it under WooCommerce settings.', 'tujo'),
